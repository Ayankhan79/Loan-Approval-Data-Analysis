...
The most important part of the project was the **bivariate analysis**, where I compared each feature with **Loan_Status** to understand what affects loan approval. I analyzed relationships between the target and features like **Gender, Married status, Dependents, Education, Self_Employed, Property_Area, ApplicantIncome, LoanAmount**, and especially **Credit_History**. One major insight was that **Credit_History is the strongest predictor** of loan approval in this dataset.

I also generated a **correlation heatmap** to study how numerical features relate to each other and to check for **multicollinearity**. Additionally, I created useful engineered features such as **Total Income**, **EMI**, and **Income-to-Loan Ratio**, which help provide deeper insights for future modeling.

---

# 🎯 **What I Learned**

From this EDA project, I learned how to:

* Clean and preprocess real-world datasets
* Handle **missing values**, **outliers**, and **skewed distributions**
* Perform **univariate, bivariate, and multivariate analysis**
* Create clear visual insights using **Matplotlib**, **Seaborn**, and **Plotly**
